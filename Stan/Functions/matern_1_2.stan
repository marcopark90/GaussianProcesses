functions {
  matrix cov_matern_1_2(vector x1, vector x2, real alpha, real rho,
...
model{
  matrix[N,N] K_exp = cov_matern_1_2(x1, x2, alpha, rho, a1, b1, a2, b2, psi1, psi2, sigma) + diag_matrix(rep_vector(1e-9, N));
